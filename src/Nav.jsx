    ...
    return (
        <div>
            ...
            <nav className="flex justify-between">
                <a className="link white hover-purple no-underline flex items-center pa5" href="">
                    <svg
                        className="dib h2 w2"
                        data-icon="grid"
                        viewBox="0 0 32 32"
                ...
                <div className="flex-grow pa3 flex items-center">
                    <a className="f6 link dib white dim mr3 mr4-ns" href="https://www.linkedin.com/in/alenanikolaeva/">About</a>
                    <a className="f6 link dib white dim mr3 mr4-ns" href="https://twitter.com/alenanik11">Twitter</a>
                    <a className="f6 link dib white dim mr3 mr4-ns" href="https://codepen.io/AlenaNik">Codepen</a>
                    <a className="f6 dib white bg-animate hover-bg-white hover-black no-underline pv2 ph4 br-pill ba b--white-20"
                       href="mailto:alena.nik.digital@gmail.com">Stay in touch</a>
                </div>
            </nav>
